...
#
# Execução: python Questao1Parte1.py
#
...
def senhas_em_regras():
	...
	for la in lista_combinada:
		...
		if proximo_eh_maior and repete_duas_vezes:
			lista_valida.append(a)

	print('Existem {} senhas que seguem as regras de números próximos sempre maior e dois dígitos adjacentes!'.format(len(lista_valida)))
	# print(lista_valida)

	#Cria arquivo planilha com o resultado
	with open('Out-Part1.csv', 'w') as f:
